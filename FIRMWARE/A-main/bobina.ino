...
int voltagens[7] = {6, 8, 10, 12, 14, 16, 18}; // Lista de voltagens fixas
void mapa_dweel(String dados) {
  ...
  for (int i = 0; i < 7; i++) {
    ...
    porcent_dwell_volt[i] = valor_str.toInt();  // Converte o valor para inteiro
...
int dwell_time_calc(int valor) {
  ...
  const int numVoltagens = 7; // Ajuste conforme necessário
